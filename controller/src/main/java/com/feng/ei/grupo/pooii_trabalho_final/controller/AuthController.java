...
public class AuthController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<@NotNull SignupResponse> signup(@RequestBody @Validated SignupRequest request) {
        return service.signup(request);
    }

    @PostMapping("/login")
    public ResponseEntity<@NotNull LoginResponse> login(@RequestBody @Validated LoginRequest request) {
